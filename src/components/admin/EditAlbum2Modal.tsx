...
import ManageAlbumSongs from "../../pages/admin/ManageAlbumSongs";
...
export const EditAlbum2Modal: React.FC<EditAlbum2ModalProps> = ({
  ...
  return (
    <Dialog
      ...
      maxWidth="md"
      slotProps={{
        paper: { className: "h-full overflow-y-hidden" },
      }}
    >
            ...
            <FormControlLabel
              control={
                <Checkbox
                  ...
                  onChange={(e) =>
                    setValue("removeCoverImage", e.target.checked)
                  }
                  disabled={!album2.backgroundUrl}
                />
              }
