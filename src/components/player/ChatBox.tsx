    ...
    <div className="fixed bottom-24 right-8 z-50 bg-gray-900 rounded-lg shadow-lg w-80 max-w-full flex flex-col border border-gray-700">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-2 max-h-72">
        ...
        {messages.map((msg, idx) => (
          ...
          >
            <div
              className={`px-3 py-2 rounded-lg text-sm break-words max-w-[80%] ${
                msg.from === "user"
        ...
        {loading && (
          <div className="flex justify-start">
            <div className="px-3 py-2 rounded-lg text-sm bg-gray-700 text-white max-w-[80%] italic opacity-80">
              Đang trả lời...
            </div>
          </div>
        )}
